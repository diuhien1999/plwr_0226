...
// test('verify able to right click and handle alert', async ({contextClickPage}) =>{
//     await contextClickPage.goto();
//     await contextClickPage.rightClickElement();
//     const alertMessage = await contextClickPage.waitForAlertAndGetMessage();
